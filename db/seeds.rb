...
Quote.create!(text: "It’s just a flesh wound.", author: "Monty Python and the Holy Grail" )
Quote.create!(text: "This building has to be at least…. three times bigger than this!", author: "Zoolander" )
Quote.create!(text: "I am serious. And don’t call me Shirley.", author: "Airplane" )
Quote.create!(text: "Yeah, but I shoot with this hand.", author: "Blazing Saddles" )
Quote.create!(text: "I’m just one stomach flu away from my goal weight.", author: "The Devil Wears Prada" )
Quote.create!(text: "Where is my supersuit?!?!?!", author: "The Incredibles" )
Quote.create!(text: "We get the warhead and we hold the world ransom for…. One million dollars.", author: "Austin Powers: International Man of Mystery" )
Quote.create!(text: "Leave the gun, take the canoli.", author: "The Godfather" )
Quote.create!(text: "I’m in a glass case of emotion!", author: "Anchorman" )
Quote.create!(text: "I’ll have what she’s having.", author: "When Harry Met Sally" )
Quote.create!(text: "It’s not a man purse. It’s called a satchel. Indiana Jones wears one.", author: "The Hangover" )
Quote.create!(text: "She doesn't even go here!", author: "Mean Girls" )
Quote.create!(text: "I am your father’s brother’s nephew’s cousin’s former roommate.", author: "Spaceballs" )
Quote.create!(text: "McLovin? What kind of stupid name is that?", author: "Superbad" )
Quote.create!(text: "That escalated quickly", author: "Anchorman" )
